...
// Description
// ===========
// This function will check the user has access to the surveys module and
...
// <rsp stat="ok" />
//
function ciniki_surveys_checkAccess($ciniki, $business_id, $method) {
    //
    // Check if the business is active and the module is enabled
    //
    ciniki_core_loadMethod($ciniki, 'ciniki', 'businesses', 'private', 'checkModuleAccess');
    $rc = ciniki_businesses_checkModuleAccess($ciniki, $business_id, 'ciniki', 'surveys');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    $modules = $rc['modules'];
